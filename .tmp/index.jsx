...
let metaType = queryObject.get('metaType') || '';
const metaPathMap = {"meta":"/Users/kanghui/projj/github.com/leoner/custom-lowcode-componet/.tmp/meta.js"};
...
if (devMode) {
  ...
  assets.components = [{
    exportName: 'AntdProtableComponentMeta',
    ...
    async init() {
      if (!devMode) {
        ...
        assets.components = devAssets.components.map(item => {
          if (item.urls && metaType && item.urls[metaType || 'default']) {
